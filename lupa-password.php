            ...
            if (isset($_POST['lupa'])) {
                ...
                if (!$username) {
                    ...
                    if ($a == 0) {
                        ...
                        $txt = "Password anda adalah : ".$a['password'];
                        $headers = "From: HRGRAM@hrgram.tk";

                        mail($to,$subject,$txt,$headers);
                        echo "<div class='alert alert-success'>Password telah dikirim ke Email anda.</div>";
                    }
                }
            }
        ?>
                ...
                <div class="panel panel-primary">
                    <div class="panel-body">
                        ...
                        <div class="form-group">
                            ...
                            <button type="submit" class="btn btn-primary pull-right" name="lupa">Kirim</button>
                        </div>
                    </div>
                </div>
            </form>
